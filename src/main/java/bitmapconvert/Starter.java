...
import bitmapconvert.CalculateCharArea.CharArea;
...
public class Starter  {
	...
	private static BufferedImage zoom(BufferedImage source_bi) throws IOException {
		...
		g.drawImage(source_bi, 10, 10, WIDTH, height * WIDTH / width, null);
		g.dispose();
	...
	public static void main(String[] args) throws IOException {
		...
		// 引入文件
		InputStream imageis = new FileInputStream(new File("C:/Users/liuyi/Desktop/图片包/20161227230732979.jpg"));
