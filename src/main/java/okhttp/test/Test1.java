...
public class Test1 {
    public static void main(String[] args) {
		...
		Request request = builder.get()
				.url("http://www.tyffm888.com//Index/Toupiao/doVote?id=110509&vote_tag=CSS60CTC&vote_user_id=g01eozPJg0Ozd8OahXni&session_id=fepe1bPGeUL7oh58&_sign_nonce_str="
						+ getMD5(UUID.randomUUID().toString()) + "&_sign_time="
						+ System.currentTimeMillis() + "&_is_ajax=1&_sign=" + UUID.randomUUID().toString())
				.build();// 2.
